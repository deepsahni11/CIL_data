...
np.save('../datasets_15d_X_train_resampled.npy',X_train_datasets_15d_resampled)
np.save('../datasets_15d_X_test_resampled.npy',X_test_datasets_15d_resampled)
np.save('../datasets_15d_y_train_resampled.npy',y_train_datasets_15d_resampled)
np.save('../datasets_15d_y_test_resampled.npy',y_test_datasets_15d_resampled)
