...
X_train_datasets_15d = []
y_train_datasets_15d = []
X_test_datasets_15d = []
y_test_datasets_15d = []
...
X_train_datasets_15d_resampled = []
y_train_datasets_15d_resampled = []
X_test_datasets_15d_resampled = []
y_test_datasets_15d_resampled = []
            ...
            for cs in class_separation:
                for num_c in num_clusters:
                    ...
                    for train_index, test_index in sss.split(X, y):
                        ...
                        y_train_datasets_15d_resampled.append(ytrain)
                        X_test_datasets_15d_resampled.append(Xtest)
                        y_test_datasets_15d_resampled.append(ytest)
...
np.save('../Data_metrics_15d_datasets_X_train.npy',X_train_datasets_15d_resampled)
np.save('../Data_metrics_15d_datasets_X_test.npy',X_test_datasets_15d_resampled)
np.save('../Data_metrics_15d_datasets_y_train.npy',y_train_datasets_15d_resampled)
np.save('../Data_metrics_15d_datasets_y_test.npy',y_test_datasets_15d_resampled)
