...
X_train_datasets_13d = []
y_train_datasets_13d = []
X_test_datasets_13d = []
y_test_datasets_13d = []
...
X_train_datasets_13d_resampled = []
y_train_datasets_13d_resampled = []
X_test_datasets_13d_resampled = []
y_test_datasets_13d_resampled = []
            ...
            for cs in class_separation:
                for num_c in num_clusters:
                    ...
                    for train_index, test_index in sss.split(X, y):
                        ...
                        X_train_datasets_13d_resampled.append(Xtrain)
                        y_train_datasets_13d_resampled.append(ytrain)
                        X_test_datasets_13d_resampled.append(Xtest)
                        y_test_datasets_13d_resampled.append(ytest)
                        
                        
                        for i in range(len(samplers_array_all)):
                            X_resampled, y_resampled = samplers_array_all[i].fit_sample(Xtrain, ytrain)
                            X_train_datasets_13d_resampled.append(X_resampled)
                            y_train_datasets_13d_resampled.append(y_resampled)
                            X_test_datasets_13d_resampled.append(Xtest)
                            y_test_datasets_13d_resampled.append(ytest)
...
np.save('../Data_metrics_13d_datasets_X_train.npy',X_train_datasets_13d_resampled)
np.save('../Data_metrics_13d_datasets_X_test.npy',X_test_datasets_13d_resampled)
np.save('../Data_metrics_13d_datasets_y_train.npy',y_train_datasets_13d_resampled)
np.save('../Data_metrics_13d_datasets_y_test.npy',y_test_datasets_13d_resampled)
