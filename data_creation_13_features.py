...
np.save('../datasets_13d_X_train_resampled.npy',X_train_datasets_13d_resampled)
np.save('../datasets_13d_X_test_resampled.npy',X_test_datasets_13d_resampled)
np.save('../datasets_13d_y_train_resampled.npy',y_train_datasets_13d_resampled)
np.save('../datasets_13d_y_test_resampled.npy',y_test_datasets_13d_resampled)
